			...
			<div class="header-area">
				...
				<i class="fas fa-truck"></i>
					...
					<div class="row logo-top-info">
						<div class="top-info transport_set">
							<div class="call call_set ">
								<h3>Позвоните нам</h3>
								<p>+7(843)212-57-00</p>		
							</div>
			...
			<section class="transport_info">
				<div class="container">
					...
					<div class="href">						
						...
						<p>></p>
						<a href="transportation_services.php" name="production">УСЛУГИ ГРУЗОПЕРЕВОЗОК</a>
					</div>

					<div class="info-transports">

						<h3>Транспортные услуги</h3>
						<p>Организация доставки продукции авто и ж/д транспортом в любую точку России и СНГ с соблюдением всех технических требований к транспортировке.
						Поставка продукции возможна при любой фасовке так как в автопарк входят шторные полуприцепы объёмом до 92 м3, а наличие автоцистерн-термосов объёмом от 28 до 32 м3 позволяет не задумываться о температурных условиях.</p>
						<p>Грузоперевозки по России и СНГ осуществляются собственным транспортом компании, в числе которого имеются как шторные полуприцепы, так и специализированные автоцистерны-термосы.</p>
						<div class="semitrailer">		
							<div class="img_semitrailer">
								<img src="/img/slide1.jpg" >
							</div>

							<h3>Характеристики полуприцепов:</h3>
							<p>Длина/Ширина/Высота - 13,6/2,5/2,7 метров.</p>
							<p>Грузоподъемность – 20 тонн.</p>
							<p>Объём кузова – 92 м3.</p>
							<p>Тип кузова – шторный полуприцеп со сдвижными боковыми стойками.</p>
							<p>Загрузка/разгрузка - Верхняя/боковая/задняя.</p>
							<p>Опции – закладные коники, ремни крепления груза, деревянная обрешетка.</p>
						</div>
						<div class="semitrailer">		
							<div class="img_semitrailer">
								<img src="/img/slide2.jpg" >
							</div>
							<h3>Характеристик автоцистерн:</h3>
							<p>Тип кузова – автоцистерна-термос.</p>
							<p>Загрузка/разгрузка – верхняя/нижняя.</p>
							<p>Количество секций – 3 и 4 секции.</p>
							<p>Объём – 28 и 32 м3.</p>
							<p>Грузоподъемность - 23,5 тонны.</p>
							<p>Опции – нержавеющая сталь, наличие ДОПОГ.</p>
						</div>


							<p class="massage-transport"> Желаете заказать грузоперевозки по России? Позвоните прямо сейчас и узнайте, сколько денег и времени сможете сэкономить, наши логисты рассчитают оптимальный маршрут и стоимость перевозки. Каждый день наша загрузка меняется, как изменяется и плавающая система скидок. Поэтому, сделав заказ сегодня, вы можете заплатить меньше, чем если позвоните через неделю.</p>
							<p>Все автомобили оснащены современными электронными системами, это позволяет устанавливать кратчайшие сроки доставки и отслеживать товар на протяжении всего пути, что называется, «от склада до склада».</p>
